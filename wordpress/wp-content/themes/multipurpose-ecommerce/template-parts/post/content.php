...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<div class="blogger">
	    ...
	    if($multipurpose_ecommerce_blog_layout == 'Default' || $multipurpose_ecommerce_blog_layout == 'Left'){ ?>
			...
			<?php if( get_theme_mod( 'multipurpose_ecommerce_date_hide',true) != '' || get_theme_mod( 'multipurpose_ecommerce_comment_hide',true) != '' || get_theme_mod( 'multipurpose_ecommerce_author_hide',true) != '') { ?>
				<div class="post-info">
					...
					<?php } ?>
	        <?php if( get_theme_mod( 'multipurpose_ecommerce_post_time',true) != '' ) { ?>
	          <span class="entry-time"><i class="<?php echo esc_attr(get_theme_mod('multipurpose_ecommerce_post_time_icon_changer','fas fa-clock')); ?>"></i> <?php echo esc_html( get_the_time() ); ?></span>
	        <?php }?>
		...
		<?php }else if($multipurpose_ecommerce_blog_layout == 'Content and Image'){ ?>
			<div class="row m-0">
