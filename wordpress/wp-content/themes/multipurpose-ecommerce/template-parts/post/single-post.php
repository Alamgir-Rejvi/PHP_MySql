		...
		<?php if( get_theme_mod( 'multipurpose_ecommerce_single_post_date',true) != '' || get_theme_mod( 'multipurpose_ecommerce_single_post_comment',true) != '' || get_theme_mod( 'multipurpose_ecommerce_single_post_author',true) != '') { ?>
			<div class="post-info">
				...
				<?php if( get_theme_mod( 'multipurpose_ecommerce_single_post_comment',true) != '') { ?>
				  <i class="<?php echo esc_attr(get_theme_mod('multipurpose_ecommerce_single_post_comment_icon_changer','fas fa-comments')); ?>"></i><span class="entry-comments"><?php comments_number( __('0 Comments','multipurpose-ecommerce'), __('0 Comments','multipurpose-ecommerce'), __('% Comments','multipurpose-ecommerce') ); ?></span><?php echo esc_html( get_theme_mod('multipurpose_ecommerce_seperator_metabox') ); ?>
				<?php } ?>
				<?php if( get_theme_mod( 'multipurpose_ecommerce_single_post_time',true) != '' ) { ?>
					<span class="entry-time"><i class="<?php echo esc_attr(get_theme_mod('multipurpose_ecommerce_single_post_time_icon_changer','fas fa-clock')); ?>"></i> <?php echo esc_html( get_the_time() ); ?></span>
				<?php }?>
			</div>
		<?php }?>
		<h1><?php the_title(); ?></h1>
