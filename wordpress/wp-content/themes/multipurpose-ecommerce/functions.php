...
function multipurpose_ecommerce_setup() {
	...
	if ( is_admin() && ('themes.php' == $pagenow) && isset( $_GET['activated'] ) ) {
		add_action( 'admin_notices', 'multipurpose_ecommerce_activation_notice' );
	}
}
...
// Dashboard Theme Notification   
function multipurpose_ecommerce_activation_notice() {
	echo '<div class="notice is-dismissible multipurpose-ecommerce-notice">';
		echo '<div class="multipurpose-ecommerce-banner">';
			echo '<div class="multipurpose-ecommerce-text">';
				echo '<h2>' . esc_html__( 'Thanks For Installing the "Multipurpose Ecommerce" Theme !', 'multipurpose-ecommerce' ) . '</h2>';
				echo '<p>' . esc_html__( 'We’re excited to help you get started with your new theme! Set up your website quickly and customizing it to suit your needs.', 'multipurpose-ecommerce' ) . '</p>';
				echo '<div class="multipurpose-ecommerce-buttons">';
					echo '<a href="' . esc_url( admin_url( 'themes.php?page=multipurpose-ecommerce-guide-page' ) ) . '">' . esc_html__( 'Get Started', 'multipurpose-ecommerce' ) . '</a>';
					echo '<a href="'. esc_url( MULTIPURPOSE_ECOMMERCE_FREE_DOC ) .'" target=_blank>' . esc_html__( 'Documentation', 'multipurpose-ecommerce' ) . '</a>';
					echo '<a href="'. esc_url( MULTIPURPOSE_ECOMMERCE_BUY_PRO ) .'" target=_blank>' . esc_html__( 'Get Premium', 'multipurpose-ecommerce' ) . '</a>';
					echo '<a class="bundle_btn" href="'. esc_url( 'https://www.themescaliber.com/products/wordpress-theme-bundle' ) .'" target=_blank>' . esc_html__( 'Bundle of 220+ Themes at $99', 'multipurpose-ecommerce' ) . '</a>';
				echo '</div>';
			echo '</div>';
			echo '<div class="multipurpose-ecommerce-image">';
...
function multipurpose_ecommerce_newsetup() {
	define('MULTIPURPOSE_ECOMMERCE_LIVE_DEMO',__('https://preview.themescaliber.com/multipurpose-ecommerce/','multipurpose-ecommerce'));
	define('MULTIPURPOSE_ECOMMERCE_BUY_PRO',__('https://www.themescaliber.com/products/premium-multipurpose-ecommerce-wordpress-theme','multipurpose-ecommerce'));
	define('MULTIPURPOSE_ECOMMERCE_PRO_DOC',__('https://preview.themescaliber.com/doc/multipurpose-ecommerce-pro/','multipurpose-ecommerce'));
	define('MULTIPURPOSE_ECOMMERCE_FREE_DOC',__('https://preview.themescaliber.com/doc/free-multipurpose-ecommerce/','multipurpose-ecommerce'));
	define('MULTIPURPOSE_ECOMMERCE_PRO_SUPPORT',__('https://www.themescaliber.com/pages/community', 'multipurpose-ecommerce'));
	...
	define('MULTIPURPOSE_ECOMMERCE_REVIEW',__('https://wordpress.org/support/theme/multipurpose-ecommerce/reviews/','multipurpose-ecommerce'));
	//footer Link
	define('MULTIPURPOSE_ECOMMERCE_CREDIT',__('https://www.themescaliber.com/products/free-multipurpose-ecommerce-wordpress-theme','multipurpose-ecommerce'));
	}
add_action( 'after_setup_theme', 'multipurpose_ecommerce_newsetup' );
...
function multipurpose_ecommerce_enable_single_post_image_dimention(){
	if(get_theme_mod('multipurpose_ecommerce_single_post_image_dimention') == 'Custom Image Size' ) {
		return true;
	}
	return false;
}
...
// Edit Link
if (!function_exists('multipurpose_ecommerce_edit_link')) :
    function multipurpose_ecommerce_edit_link($view = 'default')
    {
        global $post;
        edit_post_link(
            sprintf(
                ...
                /* translators: %s: Name of current post. Only visible to screen readers */
                    __('Edit <span class="screen-reader-text">%s</span>', 'multipurpose-ecommerce'),
                    array(
                        'span' => array(
                            'class' => array(),
                        ),
