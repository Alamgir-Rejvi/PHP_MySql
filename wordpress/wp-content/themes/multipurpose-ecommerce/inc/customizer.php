...
function multipurpose_ecommerce_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting('multipurpose_ecommerce_typography_premium_info',array(
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('multipurpose_ecommerce_typography_premium_info',array(
		'type'=> 'hidden',
		'label'	=> __('Premium Features','multipurpose-ecommerce'),
		'description' => "<ul><li>". esc_html__('Please explore our premium theme for additional settings and features.','multipurpose-ecommerce') ."</li></ul><a target='_blank' href='". esc_url(MULTIPURPOSE_ECOMMERCE_BUY_PRO) ." '>". esc_html__('Upgrade to Pro','multipurpose-ecommerce') ."</a>",
	...
	$wp_customize->add_setting('multipurpose_ecommerce_typography_theme_color_premium_info',array(
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('multipurpose_ecommerce_typography_theme_color_premium_info',array(
		'type'=> 'hidden',
		'label'	=> __('Premium Features','multipurpose-ecommerce'),
		'description' => "<ul><li>". esc_html__('Please explore our premium theme for additional settings and features.','multipurpose-ecommerce') ."</li></ul><a target='_blank' href='". esc_url(MULTIPURPOSE_ECOMMERCE_BUY_PRO) ." '>". esc_html__('Upgrade to Pro','multipurpose-ecommerce') ."</a>",
	...
	$wp_customize->add_setting('multipurpose_ecommerce_typography_shop_premium_info',array(
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('multipurpose_ecommerce_typography_shop_premium_info',array(
		'type'=> 'hidden',
		'label'	=> __('Premium Features','multipurpose-ecommerce'),
		'description' => "<ul><li>". esc_html__('Please explore our premium theme for additional settings and features.','multipurpose-ecommerce') ."</li></ul><a target='_blank' href='". esc_url(MULTIPURPOSE_ECOMMERCE_BUY_PRO) ." '>". esc_html__('Upgrade to Pro','multipurpose-ecommerce') ."</a>",
	...
	$wp_customize->add_setting('multipurpose_ecommerce_typography_layout_premium_info',array(
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('multipurpose_ecommerce_typography_layout_premium_info',array(
		'type'=> 'hidden',
		'label'	=> __('Premium Features','multipurpose-ecommerce'),
		'description' => "<ul><li>". esc_html__('Please explore our premium theme for additional settings and features.','multipurpose-ecommerce') ."</li></ul><a target='_blank' href='". esc_url(MULTIPURPOSE_ECOMMERCE_BUY_PRO) ." '>". esc_html__('Upgrade to Pro','multipurpose-ecommerce') ."</a>",
	...
	$wp_customize->add_setting('multipurpose_ecommerce_typography_button_premium_info',array(
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('multipurpose_ecommerce_typography_button_premium_info',array(
		'type'=> 'hidden',
		'label'	=> __('Premium Features','multipurpose-ecommerce'),
		'description' => "<ul><li>". esc_html__('Please explore our premium theme for additional settings and features.','multipurpose-ecommerce') ."</li></ul><a target='_blank' href='". esc_url(MULTIPURPOSE_ECOMMERCE_BUY_PRO) ." '>". esc_html__('Upgrade to Pro','multipurpose-ecommerce') ."</a>",
	...
	$wp_customize->add_setting('multipurpose_ecommerce_btn_font_size_option',array(
		'default'=> '',
		'sanitize_callback'	=> 'multipurpose_ecommerce_sanitize_float',
	));
	$wp_customize->add_control('multipurpose_ecommerce_btn_font_size_option',array(
		'label'	=> __('Button Font Size','multipurpose-ecommerce'),
		'input_attrs' => array(
         'step'             => 1,
			'min'              => 0,
			'max'              => 50,
	...
	$wp_customize->add_setting('multipurpose_ecommerce_button_text_transform',array(
		'default' => 'Uppercase',
		'sanitize_callback' => 'multipurpose_ecommerce_sanitize_choices'
 	));
 	$wp_customize->add_control('multipurpose_ecommerce_button_text_transform',array(
		'type' => 'radio',
		'label' => __('Button Text Transform','multipurpose-ecommerce'),
		'section' => 'multipurpose_ecommerce_button_option',
		'choices' => array(
		   'Uppercase' => __('Uppercase','multipurpose-ecommerce'),
		   'Lowercase' => __('Lowercase','multipurpose-ecommerce'),
		   'Capitalize' => __('Capitalize','multipurpose-ecommerce'),
		),
	));

	$wp_customize->add_setting('multipurpose_ecommerce_btn_font_weight',array(
		'default'=> '',
		'sanitize_callback'	=> 'multipurpose_ecommerce_sanitize_choices',
	));
	$wp_customize->add_control('multipurpose_ecommerce_btn_font_weight',array(
		'label'	=> __('Button Font Weight','multipurpose-ecommerce'),
		'section'=> 'multipurpose_ecommerce_button_option',
		'type' => 'select',
		'choices' => array(
            '100' => __('100','multipurpose-ecommerce'),
            '200' => __('200','multipurpose-ecommerce'),
            '300' => __('300','multipurpose-ecommerce'),
            '400' => __('400','multipurpose-ecommerce'),
            '500' => __('500','multipurpose-ecommerce'),
            '600' => __('600','multipurpose-ecommerce'),
            '700' => __('700','multipurpose-ecommerce'),
            '800' => __('800','multipurpose-ecommerce'),
            '900' => __('900','multipurpose-ecommerce'),
        ),
	));

	$wp_customize->add_setting('multipurpose_ecommerce_button_hover_effect',array(
        'default' => '',
        'sanitize_callback' => 'multipurpose_ecommerce_sanitize_choices'
    ));
	$wp_customize->add_control('multipurpose_ecommerce_button_hover_effect', array(
        'type' => 'select',
        'label' => __( 'Button Hover Effect', 'multipurpose-ecommerce' ),
        'section' => 'multipurpose_ecommerce_button_option',
        'choices' => array(
			'pulse'     => __( 'Pulse', 'multipurpose-ecommerce' ),
			'rubberBand'=> __( 'RubberBand', 'multipurpose-ecommerce' ),
			'swing'     => __( 'Swing', 'multipurpose-ecommerce' ),
			'tada'      => __( 'Tada', 'multipurpose-ecommerce' ),
			'jello'     => __( 'Jello', 'multipurpose-ecommerce' ),
			'disable'   => __( 'Disabled', 'multipurpose-ecommerce' )
        ),
    ));
	...
	$wp_customize->add_setting('multipurpose_ecommerce_typography_sidebar_premium_info',array(
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('multipurpose_ecommerce_typography_sidebar_premium_info',array(
		'type'=> 'hidden',
		'label'	=> __('Premium Features','multipurpose-ecommerce'),
		'description' => "<ul><li>". esc_html__('Please explore our premium theme for additional settings and features.','multipurpose-ecommerce') ."</li></ul><a target='_blank' href='". esc_url(MULTIPURPOSE_ECOMMERCE_BUY_PRO) ." '>". esc_html__('Upgrade to Pro','multipurpose-ecommerce') ."</a>",
	...
	$wp_customize->add_setting('multipurpose_ecommerce_single_post_sidebar_option',array(
		'default' => 'Right Sidebar',
		'sanitize_callback' => 'multipurpose_ecommerce_sanitize_choices'
   ));
   $wp_customize->add_control('multipurpose_ecommerce_single_post_sidebar_option',array(
		'type' => 'radio',
		'label' => __('Single Post Sidebar Layout','multipurpose-ecommerce'),
		'section' => 'multipurpose_ecommerce_general_option',
		'choices' => array(
			'Left Sidebar' => __('Left Sidebar','multipurpose-ecommerce'),
			'Right Sidebar' => __('Right Sidebar','multipurpose-ecommerce'),
	...
	$wp_customize->add_setting('multipurpose_ecommerce_typography_topbar_premium_info',array(
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('multipurpose_ecommerce_typography_topbar_premium_info',array(
		'type'=> 'hidden',
		'label'	=> __('Premium Features','multipurpose-ecommerce'),
		'description' => "<ul><li>". esc_html__('Please explore our premium theme for additional settings and features.','multipurpose-ecommerce') ."</li></ul><a target='_blank' href='". esc_url(MULTIPURPOSE_ECOMMERCE_BUY_PRO) ." '>". esc_html__('Upgrade to Pro','multipurpose-ecommerce') ."</a>",
	...
	$wp_customize->add_setting('multipurpose_ecommerce_typography_navigation_premium_info',array(
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('multipurpose_ecommerce_typography_navigation_premium_info',array(
		'type'=> 'hidden',
		'label'	=> __('Premium Features','multipurpose-ecommerce'),
		'description' => "<ul><li>". esc_html__('Please explore our premium theme for additional settings and features.','multipurpose-ecommerce') ."</li></ul><a target='_blank' href='". esc_url(MULTIPURPOSE_ECOMMERCE_BUY_PRO) ." '>". esc_html__('Upgrade to Pro','multipurpose-ecommerce') ."</a>",
	...
	$wp_customize->add_setting('multipurpose_ecommerce_menus_item_style',array(
        'default' => 'None',
        'transport' => 'refresh',
        'sanitize_callback' => 'multipurpose_ecommerce_sanitize_choices'
	));
	$wp_customize->add_control('multipurpose_ecommerce_menus_item_style',array(
        'type' => 'select',
		'label' => __('Menu Item Hover Style','multipurpose-ecommerce'),
		'section' => 'multipurpose_ecommerce_navigation_menu',
		'choices' => array(
            'None' => __('None','multipurpose-ecommerce'),
            'Zoom In' => __('Zoom In','multipurpose-ecommerce'),
        ),
	) );
	...
	$wp_customize->add_setting('multipurpose_ecommerce_slider_premium_info',array(
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('multipurpose_ecommerce_slider_premium_info',array(
		'type'=> 'hidden',
		'label'	=> __('Premium Features','multipurpose-ecommerce'),
		'description' => "<ul><li>". esc_html__('Added new custom fields to capture specific information relevant to your content.','multipurpose-ecommerce') ."</li><li>". esc_html__('Include customizable typography settings with a selection of premium fonts.','multipurpose-ecommerce') ."</li><li>". esc_html__('And so on...','multipurpose-ecommerce') ."</li></ul><a target='_blank' href='". esc_url(MULTIPURPOSE_ECOMMERCE_BUY_PRO) ." '>". esc_html__('Upgrade to Pro','multipurpose-ecommerce') ."</a>",
	...
	'choices' => array(
      '0' =>  esc_attr__('0','multipurpose-ecommerce'),
      '0.1' =>  esc_attr__('0.1','multipurpose-ecommerce'),
      '0.2' =>  esc_attr__('0.2','multipurpose-ecommerce'),
      '0.3' =>  esc_attr__('0.3','multipurpose-ecommerce'),
      '0.4' =>  esc_attr__('0.4','multipurpose-ecommerce'),
      '0.5' =>  esc_attr__('0.5','multipurpose-ecommerce'),
      '0.6' =>  esc_attr__('0.6','multipurpose-ecommerce'),
      '0.7' =>  esc_attr__('0.7','multipurpose-ecommerce'),
      '0.8' =>  esc_attr__('0.8','multipurpose-ecommerce'),
      '0.9' =>  esc_attr__('0.9','multipurpose-ecommerce')
	),
	));
	...
	$wp_customize->add_setting('multipurpose_ecommerce_product_premium_info',array(
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('multipurpose_ecommerce_product_premium_info',array(
		'type'=> 'hidden',
		'label'	=> __('Premium Features','multipurpose-ecommerce'),
		'description' => "<ul><li>". esc_html__('Added hide or show section on your site, giving you complete control over your content’s visibility.','multipurpose-ecommerce') ."</li><li>". esc_html__('Added custom background image and background color to create a visually appealing and dynamic design.','multipurpose-ecommerce') ."</li></ul><a target='_blank' href='". esc_url(MULTIPURPOSE_ECOMMERCE_BUY_PRO) ." '>". esc_html__('Upgrade to Pro','multipurpose-ecommerce') ."</a>",
	...
	$wp_customize->add_setting('multipurpose_ecommerce_no_result_premium_info',array(
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('multipurpose_ecommerce_no_result_premium_info',array(
		'type'=> 'hidden',
		'label'	=> __('Premium Features','multipurpose-ecommerce'),
		'description' => "<ul><li>". esc_html__('Please explore our premium theme for additional settings and features.','multipurpose-ecommerce') ."</li></ul><a target='_blank' href='". esc_url(MULTIPURPOSE_ECOMMERCE_BUY_PRO) ." '>". esc_html__('Upgrade to Pro','multipurpose-ecommerce') ."</a>",
	...
	$wp_customize->add_setting('multipurpose_ecommerce_page_not_found_premium_info',array(
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('multipurpose_ecommerce_page_not_found_premium_info',array(
		'type'=> 'hidden',
		'label'	=> __('Premium Features','multipurpose-ecommerce'),
		'description' => "<ul><li>". esc_html__('Please explore our premium theme for additional settings and features.','multipurpose-ecommerce') ."</li></ul><a target='_blank' href='". esc_url(MULTIPURPOSE_ECOMMERCE_BUY_PRO) ." '>". esc_html__('Upgrade to Pro','multipurpose-ecommerce') ."</a>",
	...
	$wp_customize->add_setting('multipurpose_ecommerce_mobile_media_premium_info',array(
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('multipurpose_ecommerce_mobile_media_premium_info',array(
		'type'=> 'hidden',
		'label'	=> __('Premium Features','multipurpose-ecommerce'),
		'description' => "<ul><li>". esc_html__('Please explore our premium theme for additional settings and features.','multipurpose-ecommerce') ."</li></ul><a target='_blank' href='". esc_url(MULTIPURPOSE_ECOMMERCE_BUY_PRO) ." '>". esc_html__('Upgrade to Pro','multipurpose-ecommerce') ."</a>",
	...
	$wp_customize->add_setting('multipurpose_ecommerce_post_premium_info',array(
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('multipurpose_ecommerce_post_premium_info',array(
		'type'=> 'hidden',
		'label'	=> __('Premium Features','multipurpose-ecommerce'),
		'description' => "<ul><li>". esc_html__('Please explore our premium theme for additional settings and features.','multipurpose-ecommerce') ."</li></ul><a target='_blank' href='". esc_url(MULTIPURPOSE_ECOMMERCE_BUY_PRO) ." '>". esc_html__('Upgrade to Pro','multipurpose-ecommerce') ."</a>",
    ...
    $wp_customize->add_setting('multipurpose_ecommerce_post_time',array(
       'default' => true,
       'sanitize_callback'	=> 'multipurpose_ecommerce_sanitize_checkbox'
    ));
    $wp_customize->add_control('multipurpose_ecommerce_post_time',array(
       'type' => 'checkbox',
       'label' => __('Post Time','multipurpose-ecommerce'),
       'section' => 'multipurpose_ecommerce_blog_post'
    ));

	$wp_customize->add_setting('multipurpose_ecommerce_post_time_icon_changer',array(
		'default'	=> 'fas fa-clock',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new multipurpose_ecommerce_Icon_Changer(
        $wp_customize,'multipurpose_ecommerce_post_time_icon_changer',array(
		'label'	=> __('Post Time Icon','multipurpose-ecommerce'),
		'transport' => 'refresh',
		'section'	=> 'multipurpose_ecommerce_blog_post',
		'type'		=> 'icon'
	)));
    ...
    $wp_customize->add_control('multipurpose_ecommerce_blog_post_layout',array(
        ...
        'choices' => array(
			...
			'Content and Image' => __('Content and Image','multipurpose-ecommerce'),
        ),
	) );
    ...
    $wp_customize->add_setting('multipurpose_ecommerce_post_pagination_option',array(
    	'default' => 'Left',
        'sanitize_callback' => 'multipurpose_ecommerce_sanitize_choices'
	));
	$wp_customize->add_control('multipurpose_ecommerce_post_pagination_option',array(
        'type' => 'select',
        'label' => __('Post Pagination Alignment','multipurpose-ecommerce'),
        'section' => 'multipurpose_ecommerce_blog_post',
        'choices' => array(
            'Center' => __('Center','multipurpose-ecommerce'),
            'Left' => __('Left','multipurpose-ecommerce'),
	...
	$wp_customize->add_setting('multipurpose_ecommerce_single_post_premium_info',array(
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('multipurpose_ecommerce_single_post_premium_info',array(
		'type'=> 'hidden',
		'label'	=> __('Premium Features','multipurpose-ecommerce'),
		'description' => "<ul><li>". esc_html__('Please explore our premium theme for additional settings and features.','multipurpose-ecommerce') ."</li></ul><a target='_blank' href='". esc_url(MULTIPURPOSE_ECOMMERCE_BUY_PRO) ." '>". esc_html__('Upgrade to Pro','multipurpose-ecommerce') ."</a>",
	...
	$wp_customize->add_setting('multipurpose_ecommerce_single_post_image_dimention',array(
		'default' => 'Default',
		'sanitize_callback'	=> 'multipurpose_ecommerce_sanitize_choices'
	));
	$wp_customize->add_control('multipurpose_ecommerce_single_post_image_dimention',array(
		'type' => 'radio',
		'label'	=> __('Single Post Featured Image Dimention','multipurpose-ecommerce'),
		'choices' => array(
			'Default' => __('Default','multipurpose-ecommerce'),
			'Custom Image Size' => __('Custom Image Size','multipurpose-ecommerce'),
		),
	...
	$wp_customize->add_setting( 'multipurpose_ecommerce_single_post_featured_image_width',array(
		'default' => '',
		'sanitize_callback'	=> 'multipurpose_ecommerce_sanitize_number_range'
	));
	$wp_customize->add_control('multipurpose_ecommerce_single_post_featured_image_width',	array(
		'label' => esc_html__( 'Single Blog Post Custom Width','multipurpose-ecommerce' ),
		'section' => 'multipurpose_ecommerce_single_post_section',
		'input_attrs' => array(
			'min' => 0,
			'max' => 900,
		...
		'type' => 'range',
		'active_callback' => 'multipurpose_ecommerce_enable_single_post_image_dimention'
	));
 
	$wp_customize->add_setting( 'multipurpose_ecommerce_single_post_featured_image_height',array(
		'default' => '',
		'sanitize_callback'	=> 'multipurpose_ecommerce_sanitize_number_range'
	));
	$wp_customize->add_control('multipurpose_ecommerce_single_post_featured_image_height',	array(
		'label' => esc_html__( 'Single Blog Post Custom Height','multipurpose-ecommerce' ),
		'section' => 'multipurpose_ecommerce_single_post_section',
		'input_attrs' => array(
			'min' => 0,
			'max' => 900,
    ...
    $wp_customize->add_setting('multipurpose_ecommerce_single_post_time',array(
       'default' => true,
       'sanitize_callback'	=> 'multipurpose_ecommerce_sanitize_checkbox'
    ));
    $wp_customize->add_control('multipurpose_ecommerce_single_post_time',array(
       'type' => 'checkbox',
       'label' => __('Single Post Time','multipurpose-ecommerce'),
       'section' => 'multipurpose_ecommerce_single_post_section'
    ));

	$wp_customize->add_setting('multipurpose_ecommerce_single_post_time_icon_changer',array(
		'default'	=> 'fas fa-clock',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new multipurpose_ecommerce_Icon_Changer(
        $wp_customize,'multipurpose_ecommerce_single_post_time_icon_changer',array(
		'label'	=> __('Single Post Time Icon','multipurpose-ecommerce'),
		'transport' => 'refresh',
		'section'	=> 'multipurpose_ecommerce_single_post_section',
		'type'		=> 'icon'
	)));
	...
	$wp_customize->add_setting('multipurpose_ecommerce_related_post_premium_info',array(
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('multipurpose_ecommerce_related_post_premium_info',array(
		'type'=> 'hidden',
		'label'	=> __('Premium Features','multipurpose-ecommerce'),
		'description' => "<ul><li>". esc_html__('Please explore our premium theme for additional settings and features.','multipurpose-ecommerce') ."</li></ul><a target='_blank' href='". esc_url(MULTIPURPOSE_ECOMMERCE_BUY_PRO) ." '>". esc_html__('Upgrade to Pro','multipurpose-ecommerce') ."</a>",
	...
	$wp_customize->add_setting('multipurpose_ecommerce_related_post_date_hide',array(
		'default' => true,
		'sanitize_callback'	=> 'multipurpose_ecommerce_sanitize_checkbox'
	));
	$wp_customize->add_control('multipurpose_ecommerce_related_post_date_hide',array(
		'type' => 'checkbox',
		'label' => __('Post Date','multipurpose-ecommerce'),
		'section' => 'multipurpose_ecommerce_related_post_section'
	));

	$wp_customize->add_setting('multipurpose_ecommerce_related_post_author_hide',array(
		'default' => true,
		'sanitize_callback'	=> 'multipurpose_ecommerce_sanitize_checkbox'
	));
	$wp_customize->add_control('multipurpose_ecommerce_related_post_author_hide',array(
		'type' => 'checkbox',
		'label' => __('Post Author','multipurpose-ecommerce'),
		'section' => 'multipurpose_ecommerce_related_post_section'
	));

	$wp_customize->add_setting('multipurpose_ecommerce_related_post_comment_hide',array(
		'default' => true,
		'sanitize_callback'	=> 'multipurpose_ecommerce_sanitize_checkbox'
	));
	$wp_customize->add_control('multipurpose_ecommerce_related_post_comment_hide',array(
		'type' => 'checkbox',
		'label' => __('Post Comments','multipurpose-ecommerce'),
		'section' => 'multipurpose_ecommerce_related_post_section'
	));

	$wp_customize->add_setting('multipurpose_ecommerce_related_post_time',array(
		'default' => true,
		'sanitize_callback'	=> 'multipurpose_ecommerce_sanitize_checkbox'
	));
	$wp_customize->add_control('multipurpose_ecommerce_related_post_time',array(
		'type' => 'checkbox',
		'label' => __('Post Time','multipurpose-ecommerce'),
		'section' => 'multipurpose_ecommerce_related_post_section'
	));
	...
	$wp_customize->add_setting('multipurpose_ecommerce_show_related_post_image',array(
		'default' => true,
		'sanitize_callback'	=> 'multipurpose_ecommerce_sanitize_checkbox'
	 ));
	 $wp_customize->add_control('multipurpose_ecommerce_show_related_post_image',array(
		'type' => 'checkbox',
		'label' => __('Post Image','multipurpose-ecommerce'),
		'section' => 'multipurpose_ecommerce_related_post_section'
	 ));

	 $wp_customize->add_setting( 'multipurpose_ecommerce_related_post_image_shadow',array(
		'default' => 0,
		'sanitize_callback'    => 'multipurpose_ecommerce_sanitize_float',
	));
	$wp_customize->add_control('multipurpose_ecommerce_related_post_image_shadow',array(
		'label' => esc_html__( 'Post Image Shadow','multipurpose-ecommerce' ),
		'section' => 'multipurpose_ecommerce_related_post_section',
		'input_attrs' => array(
			'min' => 0,
	...
	$wp_customize->add_setting('multipurpose_ecommerce_related_button_text',array(
		'default'=> esc_html__('Continue Reading....','multipurpose-ecommerce'),
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('multipurpose_ecommerce_related_button_text',array(
		'label'	=> esc_html__('Add Button Text','multipurpose-ecommerce'),
		'input_attrs' => array(
        'placeholder' => esc_html__( 'Read More', 'multipurpose-ecommerce' ),
        ),
		'section'=> 'multipurpose_ecommerce_related_post_section',
		'type'=> 'text'
	));
	...
	// Grid post
	$wp_customize->add_section( 'multipurpose_ecommerce_grid_layout_settings', array(
		'title' => __( 'Grid Layout Settings', 'multipurpose-ecommerce' ),
		'panel' => 'multipurpose_ecommerce_panel_id',
	));

	$wp_customize->add_setting('multipurpose_ecommerce_grid_post_metabox_seperator',array(
		'default' => '|',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('multipurpose_ecommerce_grid_post_metabox_seperator',array(
		'type' => 'text',
		'label' => __('Metabox Seperator','multipurpose-ecommerce'),
		'description' => __('Ex: "/", "|", "-", ...','multipurpose-ecommerce'),
		'section' => 'multipurpose_ecommerce_grid_layout_settings'
	));

	$wp_customize->add_setting('multipurpose_ecommerce_grid_post_date',array(
		'default' => 'true',
		'sanitize_callback'	=> 'multipurpose_ecommerce_sanitize_checkbox'
	));
	$wp_customize->add_control('multipurpose_ecommerce_grid_post_date',array(
		'type' => 'checkbox',
		'label' => __('Show / Hide Date ','multipurpose-ecommerce'),
		'section' => 'multipurpose_ecommerce_grid_layout_settings'
	));

	$wp_customize->add_setting('multipurpose_ecommerce_grid_post_date_icon',array(
		'default'	=> 'fas fa-calendar-alt',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new Multipurpose_Ecommerce_Icon_Changer(
		$wp_customize,'multipurpose_ecommerce_grid_post_date_icon',array(
		'label'	=> __('Grid Post Date Icon','multipurpose-ecommerce'),
		'transport' => 'refresh',
		'section'	=> 'multipurpose_ecommerce_grid_layout_settings',
		'setting'	=> 'multipurpose_ecommerce_grid_post_date_icon',
		'type'		=> 'icon'
	)));

	$wp_customize->add_setting('multipurpose_ecommerce_grid_post_author',array(
		'default' => 'true',
		'sanitize_callback'	=> 'multipurpose_ecommerce_sanitize_checkbox'
	));
	$wp_customize->add_control('multipurpose_ecommerce_grid_post_author',array(
		'type' => 'checkbox',
		'label' => __('Show / Hide Author','multipurpose-ecommerce'),
		'section' => 'multipurpose_ecommerce_grid_layout_settings'
	));

	$wp_customize->add_setting('multipurpose_ecommerce_grid_post_author_icon',array(
		'default'	=> 'fa fa-user',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new Multipurpose_Ecommerce_Icon_Changer(
		$wp_customize,'multipurpose_ecommerce_grid_post_author_icon',array(
		'label'	=> __('Grid Post Author Icon','multipurpose-ecommerce'),
		'transport' => 'refresh',
		'section'	=> 'multipurpose_ecommerce_grid_layout_settings',
		'type'		=> 'icon'
	)));

	$wp_customize->add_setting('multipurpose_ecommerce_grid_post_comment',array(
		'default' => 'true',
		'sanitize_callback'	=> 'multipurpose_ecommerce_sanitize_checkbox'
	));
	$wp_customize->add_control('multipurpose_ecommerce_grid_post_comment',array(
		'type' => 'checkbox',
		'label' => __('Show / Hide Comments','multipurpose-ecommerce'),
		'section' => 'multipurpose_ecommerce_grid_layout_settings'
	));

	$wp_customize->add_setting('multipurpose_ecommerce_grid_post_comment_icon',array(
		'default'	=> 'fas fa-comments',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new Multipurpose_Ecommerce_Icon_Changer(
		$wp_customize,'multipurpose_ecommerce_grid_post_comment_icon',array(
		'label'	=> __('Grid Post Comments Icon','multipurpose-ecommerce'),
		'transport' => 'refresh',
		'section'	=> 'multipurpose_ecommerce_grid_layout_settings',
		'type'		=> 'icon'
	)));

	$wp_customize->add_setting('multipurpose_ecommerce_grid_post_time',array(
		'default' => 'true',
		'sanitize_callback'	=> 'multipurpose_ecommerce_sanitize_checkbox'
	));
	$wp_customize->add_control('multipurpose_ecommerce_grid_post_time',array(
		'type' => 'checkbox',
		'label' => __('Show / Hide Time','multipurpose-ecommerce'),
		'section' => 'multipurpose_ecommerce_grid_layout_settings'
	));

	$wp_customize->add_setting('multipurpose_ecommerce_grid_post_time_icon',array(
		'default'	=> 'fas fa-clock',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new Multipurpose_Ecommerce_Icon_Changer(
		$wp_customize,'multipurpose_ecommerce_grid_post_time_icon',array(
		'label'	=> __('Grid Post Time Icon','multipurpose-ecommerce'),
		'transport' => 'refresh',
		'section'	=> 'multipurpose_ecommerce_grid_layout_settings',
		'type'		=> 'icon'
	)));

	$wp_customize->add_setting('multipurpose_ecommerce_grid_post_content',array(
    	'default'   => 'Post Excerpt',
     	'sanitize_callback' => 'multipurpose_ecommerce_sanitize_choices'
	));
	$wp_customize->add_control('multipurpose_ecommerce_grid_post_content',array(
		'type' => 'select',
		'label' => __('Grid Post Description','multipurpose-ecommerce'),
		'section' => 'multipurpose_ecommerce_grid_layout_settings',
		'choices' => array(
		   'None' => __('None','multipurpose-ecommerce'),
		   'Post Excerpt' => __('Post Excerpt','multipurpose-ecommerce'),
 	...
 	$wp_customize->add_setting( 'multipurpose_ecommerce_grid_excerpt_number', array(
		'default'              => 20,
		'sanitize_callback'	=> 'multipurpose_ecommerce_sanitize_float',
	) );
	$wp_customize->add_control( 'multipurpose_ecommerce_grid_excerpt_number', array(
		'label'       => esc_html__( 'Grid Post Excerpt length','multipurpose-ecommerce' ),
		'section'     => 'multipurpose_ecommerce_grid_layout_settings',
		'type'        => 'range',
		'settings'    => 'multipurpose_ecommerce_grid_excerpt_number',
		'input_attrs' => array(
			'step'             => 2,
			'min'              => 0,
			'max'              => 50,
	...
	$wp_customize->add_setting( 'multipurpose_ecommerce_grid_excerpt_suffix', array(
		'default'   => __('{...}','multipurpose-ecommerce'),
		'sanitize_callback'	=> 'sanitize_text_field'
	) );
	$wp_customize->add_control( 'multipurpose_ecommerce_grid_excerpt_suffix', array(
		'label'       => esc_html__( 'Grid Post Excerpt Indicator','multipurpose-ecommerce' ),
		'section'     => 'multipurpose_ecommerce_grid_layout_settings',
		'type'        => 'text',
		'settings'    => 'multipurpose_ecommerce_grid_excerpt_suffix',
	) );
	...
	$wp_customize->add_setting('multipurpose_ecommerce_footer_premium_info',array(
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('multipurpose_ecommerce_footer_premium_info',array(
		'type'=> 'hidden',
		'label'	=> __('Premium Features','multipurpose-ecommerce'),
		'description' => "<ul><li>". esc_html__('Please explore our premium theme for additional settings and features.','multipurpose-ecommerce') ."</li></ul><a target='_blank' href='". esc_url(MULTIPURPOSE_ECOMMERCE_BUY_PRO) ." '>". esc_html__('Upgrade to Pro','multipurpose-ecommerce') ."</a>",
	...
	$wp_customize->add_setting('multipurpose_ecommerce_footer_heading_option',array(
    	'default' => 'Left',
        'sanitize_callback' => 'multipurpose_ecommerce_sanitize_choices'
	));
	$wp_customize->add_control('multipurpose_ecommerce_footer_heading_option',array(
        'type' => 'select',
        'label' => __('Footer Heading Alignment','multipurpose-ecommerce'),
        'section' => 'multipurpose_ecommerce_footer',
        'choices' => array(
            'Center' => __('Center','multipurpose-ecommerce'),
            'Left' => __('Left','multipurpose-ecommerce'),
	...
	$wp_customize->add_setting('multipurpose_ecommerce_footer_text_tranform',array(
		'default' => 'Capitalize',
		'sanitize_callback' => 'multipurpose_ecommerce_sanitize_choices'
 	));
 	$wp_customize->add_control('multipurpose_ecommerce_footer_text_tranform',array(
		'type' => 'select',
		'label' => __('Footer Heading Text Transform','multipurpose-ecommerce'),
		'section' => 'multipurpose_ecommerce_footer',
		'choices' => array(
		   'Uppercase' => __('Uppercase','multipurpose-ecommerce'),
		   'Lowercase' => __('Lowercase','multipurpose-ecommerce'),
	...
	$wp_customize->add_setting('multipurpose_ecommerce_heading_fontsize',array(
		'default'	=> 25,
		'sanitize_callback'	=> 'multipurpose_ecommerce_sanitize_float',
	));	
	$wp_customize->add_control('multipurpose_ecommerce_heading_fontsize',array(
		'label'	=> __('Footer Heading Font Size','multipurpose-ecommerce'),
		'section'	=> 'multipurpose_ecommerce_footer',
		'type'		=> 'number'
	));

	$wp_customize->add_setting('multipurpose_ecommerce_footer_content_option',array(
    	'default' => 'Left',
        'sanitize_callback' => 'multipurpose_ecommerce_sanitize_choices'
	));
	$wp_customize->add_control('multipurpose_ecommerce_footer_content_option',array(
        'type' => 'select',
        'label' => __('Footer Content Alignment','multipurpose-ecommerce'),
        'section' => 'multipurpose_ecommerce_footer',
        'choices' => array(
            'Center' => __('Center','multipurpose-ecommerce'),
            'Left' => __('Left','multipurpose-ecommerce'),
	...
	$wp_customize->add_setting('multipurpose_ecommerce_footer_padding',array(
		'default'=> '',
		'sanitize_callback' => 'sanitize_text_field'
		));
	$wp_customize->add_control('multipurpose_ecommerce_footer_padding',array(
		'label' => __('Footer Top Bottom Padding','multipurpose-ecommerce'),
		'description' => __('Enter a value in pixels. Example:20px','multipurpose-ecommerce'),
		'input_attrs' => array(
			'placeholder' => __( '10px', 'multipurpose-ecommerce' ),
		),
		'section'=> 'multipurpose_ecommerce_footer',
		'type'=> 'text'
	));
	...
	//Footer Social Icons
	$wp_customize->add_section('multipurpose_ecommerce_social_icons_section',array(
		'title'	=> __('Footer Social Icons','multipurpose-ecommerce'),
		'priority'	=> null,
		'panel' => 'multipurpose_ecommerce_panel_id',
	));
	$wp_customize->selective_refresh->add_partial(
		'multipurpose_ecommerce_facebook_url',
		array(
			'selector'        => '.social-media',
			'render_callback' => 'multipurpose_ecommerce_customize_partial_multipurpose_ecommerce_facebook_url',
		)
	);
	$wp_customize->add_setting('multipurpose_ecommerce_show_footer_social_icon',array(
        'default' => true,
        'sanitize_callback'	=> 'multipurpose_ecommerce_sanitize_checkbox'
	));
	$wp_customize->add_control('multipurpose_ecommerce_show_footer_social_icon',array(
     	'type' => 'checkbox',
      	'label' => __('Show/Hide Social Icons','multipurpose-ecommerce'),
      	'section' => 'multipurpose_ecommerce_social_icons_section',
	));
	$wp_customize->add_setting('multipurpose_ecommerce_footer_facebook_url',array(
		'default'	=> '',
		'sanitize_callback'	=> 'esc_url_raw'
	));
	$wp_customize->add_control('multipurpose_ecommerce_footer_facebook_url',array(
		'label'	=> __('Add Facebook URL','multipurpose-ecommerce'),
		'section'	=> 'multipurpose_ecommerce_social_icons_section',
		'setting'	=> 'multipurpose_ecommerce_footer_facebook_url',
		'type'	=> 'url'
	));
	$wp_customize->add_setting('multipurpose_ecommerce_footer_facebook_icon',array(
		'default'	=> 'fab fa-facebook-f',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new multipurpose_ecommerce_Icon_Changer(
		$wp_customize,'multipurpose_ecommerce_footer_facebook_icon',array(
		'label'	=> __('Add Facebook Icon','multipurpose-ecommerce'),
		'transport' => 'refresh',
		'section'	=> 'multipurpose_ecommerce_social_icons_section',
		'setting'	=> 'multipurpose_ecommerce_footer_facebook_icon',
		'type'		=> 'icon'
	)));

	$wp_customize->add_setting('multipurpose_ecommerce_footer_twitter_url',array(
		'default'	=> '',
		'sanitize_callback'	=> 'esc_url_raw'
	));
	$wp_customize->add_control('multipurpose_ecommerce_footer_twitter_url',array(
		'label'	=> __('Add Twitter URL','multipurpose-ecommerce'),
		'section'	=> 'multipurpose_ecommerce_social_icons_section',
		'setting'	=> 'multipurpose_ecommerce_footer_twitter_url',
		'type'	=> 'url'
	));
	$wp_customize->add_setting('multipurpose_ecommerce_footer_twitter_icon',array(
		'default'	=> 'fab fa-twitter',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new multipurpose_ecommerce_Icon_Changer(
		$wp_customize,'multipurpose_ecommerce_footer_twitter_icon',array(
		'label'	=> __('Add Twitter Icon','multipurpose-ecommerce'),
		'transport' => 'refresh',
		'section'	=> 'multipurpose_ecommerce_social_icons_section',
		'setting'	=> 'multipurpose_ecommerce_footer_twitter_icon',
		'type'		=> 'icon'
	)));
	$wp_customize->add_setting('multipurpose_ecommerce_footer_instagram_url',array(
		'default'	=> '',
		'sanitize_callback'	=> 'esc_url_raw'
	));	
	$wp_customize->add_control('multipurpose_ecommerce_footer_instagram_url',array(
		'label'	=> __('Add Instagram URL','multipurpose-ecommerce'),
		'section'	=> 'multipurpose_ecommerce_social_icons_section',
		'setting'	=> 'multipurpose_ecommerce_footer_instagram_url',
		'type'	=> 'url'
	));
	$wp_customize->add_setting('multipurpose_ecommerce_footer_instagram_icon',array(
		'default'	=> 'fab fa-instagram',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new multipurpose_ecommerce_Icon_Changer(
		$wp_customize,'multipurpose_ecommerce_footer_instagram_icon',array(
		'label'	=> __('Add Instagram Icon','multipurpose-ecommerce'),
		'transport' => 'refresh',
		'section'	=> 'multipurpose_ecommerce_social_icons_section',
		'setting'	=> 'multipurpose_ecommerce_footer_instagram_icon',
		'type'		=> 'icon'
	)));
	$wp_customize->add_setting('multipurpose_ecommerce_footer_linkedin_url',array(
        'default' => '',
        'sanitize_callback'	=> 'esc_url_raw'
	));
	$wp_customize->add_control('multipurpose_ecommerce_footer_linkedin_url',array(
     	'type' => 'url',
	   	'label' => __('Add Linkedin URL','multipurpose-ecommerce'),
	   	'section' => 'multipurpose_ecommerce_social_icons_section',
	));

	$wp_customize->add_setting('multipurpose_ecommerce_footer_linkedin_icon',array(
		'default'	=> 'fab fa-linkedin',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new multipurpose_ecommerce_Icon_Changer(
        $wp_customize,'multipurpose_ecommerce_footer_linkedin_icon',array(
		'label'	=> __('Add Linkedin Icon','multipurpose-ecommerce'),
		'transport' => 'refresh',
		'section'	=> 'multipurpose_ecommerce_social_icons_section',
		'setting'	=> 'multipurpose_ecommerce_linkedin_icon',
		'type'		=> 'icon'
	)));	
	$wp_customize->add_setting( 'multipurpose_ecommerce_footer_icon_font_size', array(
		'default'           => '',
		'sanitize_callback' => 'multipurpose_ecommerce_sanitize_float',
	) );
	$wp_customize->add_control( 'multipurpose_ecommerce_footer_icon_font_size', array(
		'label' => __( 'Icon Font Size','multipurpose-ecommerce' ),
		'section'     => 'multipurpose_ecommerce_social_icons_section',
		'type'        => 'number',
		'input_attrs' => array(
			'step' => 1,
	...
	$wp_customize->add_setting('multipurpose_ecommerce_footer_icon_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'multipurpose_ecommerce_footer_icon_color', array(
		'label'    => __('Icon Color', 'multipurpose-ecommerce'),
		'section'  => 'multipurpose_ecommerce_social_icons_section',
	)));
	...
	public function sections( $manager ) {
		...
		$manager->add_section(
			new multipurpose_ecommerce_Customize_Section_Pro(
				...
				array(
					'priority'   => 9,
					'title'    => esc_html__( 'EXPLORE OUR PREMIUM FEATURES', 'multipurpose-ecommerce' ),
					'pro_text' => esc_html__( 'Upgrade To Pro', 'multipurpose-ecommerce' ),
					'pro_url'  => esc_url('https://www.themescaliber.com/products/premium-multipurpose-ecommerce-wordpress-theme')
				)
			)
		);
	}
