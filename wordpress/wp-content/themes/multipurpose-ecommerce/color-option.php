<?php
	...
	if($multipurpose_ecommerce_theme_color != false){
		$multipurpose_ecommerce_custom_css .=' .logo h1 a, .navigation-top .current-menu-item > a, .navigation-top .current_page_item > a, .main-navigation a:hover, .woocommerce div.product p.price, .woocommerce div.product span.price, .woocommerce ul.products li.product .price, .woocommerce ul.products li.product .buttons, a.post-link:hover, .category a:hover, .date a:hover, .product_meta a,.main-navigation ul ul li a,.main-navigation li li:focus > a,.main-navigation li li:hover > a, .post-info a:hover, #sidebox ul li a:hover, .site-footer ul li a:hover,.logo h1 a, .site-title, .site-title a, .site-title a:hover, .blogger a:hover, p.logged-in-as a:hover,.page-box .category a:hover, .related-posts h3 a:hover, #sidebox a:hover, .blogger h2 a:hover, .entry-date:hover a, .entry-date:hover i, .entry-author:hover a, .entry-author:hover i{';
	...
	$multipurpose_ecommerce_btn_font_size_option = get_theme_mod('multipurpose_ecommerce_btn_font_size_option', 15);
	$multipurpose_ecommerce_custom_css .='#slider-section .slide-button a, .form-submit input[type="submit"],a.post-link, .about-btn a{';
	$multipurpose_ecommerce_custom_css .='font-size: '.esc_attr($multipurpose_ecommerce_btn_font_size_option).'px;';
	$multipurpose_ecommerce_custom_css .='}';
	...
	$multipurpose_ecommerce_theme_lay = get_theme_mod( 'multipurpose_ecommerce_button_text_transform','Uppercase');
	   if($multipurpose_ecommerce_theme_lay == 'Uppercase'){
		$multipurpose_ecommerce_custom_css .='a.post-link{';
		$multipurpose_ecommerce_custom_css .='text-transform: uppercase;';
		$multipurpose_ecommerce_custom_css .='}';
	   }else if($multipurpose_ecommerce_theme_lay == 'Lowercase'){
		$multipurpose_ecommerce_custom_css .='a.post-link{';
		$multipurpose_ecommerce_custom_css .='text-transform: lowercase;';
		$multipurpose_ecommerce_custom_css .='}';
	   }
	   else if($multipurpose_ecommerce_theme_lay == 'Capitalize'){
	    $multipurpose_ecommerce_custom_css .='a.post-link{';
	...
	// font weight
    $multipurpose_ecommerce_btn_font_weight = get_theme_mod('multipurpose_ecommerce_btn_font_weight');{
	$multipurpose_ecommerce_custom_css .='a.post-link{';
	$multipurpose_ecommerce_custom_css .='font-weight: '.esc_attr($multipurpose_ecommerce_btn_font_weight).';';
	$multipurpose_ecommerce_custom_css .='}';
	}   

	//Button hover effect
	$multipurpose_ecommerce_button_hover_effect = get_theme_mod('multipurpose_ecommerce_button_hover_effect', 'disable');
	if ($multipurpose_ecommerce_button_hover_effect !== 'disable') {
		$multipurpose_ecommerce_custom_css .= 'a.post-link { display: inline-block; }';
		$multipurpose_ecommerce_custom_css .= 'a.post-link:hover {';
		
		switch ($multipurpose_ecommerce_button_hover_effect) {
			case 'pulse':
				$multipurpose_ecommerce_custom_css .= 'animation: pulse 0.5s ease-in-out;';
				break;
			case 'rubberBand':
				$multipurpose_ecommerce_custom_css .= 'animation: rubberBand 0.5s ease-in-out;';
				break;
			case 'swing':
				$multipurpose_ecommerce_custom_css .= 'animation: swing 0.5s ease-in-out;';
				break;
			case 'tada':
				$multipurpose_ecommerce_custom_css .= 'animation: tada 0.5s ease-in-out;';
				break;
			case 'jello':
				$multipurpose_ecommerce_custom_css .= 'animation: jello 0.5s ease-in-out;';
				break;
		}
		$multipurpose_ecommerce_custom_css .= '}';
	}
    ...
    if($multipurpose_ecommerce_theme_lay == 'Default'){
		...
		$multipurpose_ecommerce_custom_css .='.post-info{';
			$multipurpose_ecommerce_custom_css .='margin:10px 0;';
		$multipurpose_ecommerce_custom_css .='}';
	}else if($multipurpose_ecommerce_theme_lay == 'Content and Image'){
		$multipurpose_ecommerce_custom_css .='.blogger, .blogger h2, .post-info, .text p, #our-services p{';
			$multipurpose_ecommerce_custom_css .='text-align:Left;';
		$multipurpose_ecommerce_custom_css .='}';
		$multipurpose_ecommerce_custom_css .='.blogger .post-link{';
	...
	$multipurpose_ecommerce_footer_heading_alignment = get_theme_mod( 'multipurpose_ecommerce_footer_heading_option','Left');
    if($multipurpose_ecommerce_footer_heading_alignment == 'Left'){
		$multipurpose_ecommerce_custom_css .='.site-footer h3{';
		$multipurpose_ecommerce_custom_css .='text-align: left;';
		$multipurpose_ecommerce_custom_css .='}';
	}else if($multipurpose_ecommerce_footer_heading_alignment == 'Center'){
		$multipurpose_ecommerce_custom_css .='.site-footer h3{';
			$multipurpose_ecommerce_custom_css .='text-align: center;';
		$multipurpose_ecommerce_custom_css .='}';
	}else if($multipurpose_ecommerce_footer_heading_alignment == 'Right'){
		$multipurpose_ecommerce_custom_css .='.site-footer h3{';
			$multipurpose_ecommerce_custom_css .='text-align: right;';
		$multipurpose_ecommerce_custom_css .='}';
	}
	...
	$multipurpose_ecommerce_theme_lay = get_theme_mod( 'multipurpose_ecommerce_footer_text_tranform','Capitalize');
	if($multipurpose_ecommerce_theme_lay == 'Uppercase'){
		$multipurpose_ecommerce_custom_css .='.site-footer h3{';
			$multipurpose_ecommerce_custom_css .='text-transform: Uppercase!important;';
		$multipurpose_ecommerce_custom_css .='}';
	}else if($multipurpose_ecommerce_theme_lay == 'Lowercase'){
		$multipurpose_ecommerce_custom_css .='.site-footer h3{';
			$multipurpose_ecommerce_custom_css .='text-transform: Lowercase!important;';
		$multipurpose_ecommerce_custom_css .='}';
	}
	else if($multipurpose_ecommerce_theme_lay == 'Capitalize'){
		$multipurpose_ecommerce_custom_css .='.site-footer h3{';
			$multipurpose_ecommerce_custom_css .='text-transform: Capitalize!important;';
		$multipurpose_ecommerce_custom_css .='}';
	}	

	// footer heading font size
	$multipurpose_ecommerce_heading_fontsize = get_theme_mod('multipurpose_ecommerce_heading_fontsize',25);
	if($multipurpose_ecommerce_heading_fontsize != false){
		$multipurpose_ecommerce_custom_css .='.site-footer h3, .site-footer h2, .site-footer .wp-block-search__label,.site-footer .wp-block-heading{';
			$multipurpose_ecommerce_custom_css .='font-size: '.esc_attr($multipurpose_ecommerce_heading_fontsize).'px; ';
		$multipurpose_ecommerce_custom_css .='}';
	}

	$multipurpose_ecommerce_footer_content_alignment = get_theme_mod( 'multipurpose_ecommerce_footer_content_option','Left');
    if($multipurpose_ecommerce_footer_content_alignment == 'Left'){
		$multipurpose_ecommerce_custom_css .='.site-footer ul, .site-footer p, .site-footer .tagcloud{';
		$multipurpose_ecommerce_custom_css .='text-align: left;';
		$multipurpose_ecommerce_custom_css .='}';
	}else if($multipurpose_ecommerce_footer_content_alignment == 'Center'){
		$multipurpose_ecommerce_custom_css .='.site-footer ul, .site-footer p, .site-footer .tagcloud{';
			$multipurpose_ecommerce_custom_css .='text-align: center;';
		$multipurpose_ecommerce_custom_css .='}';
	}else if($multipurpose_ecommerce_footer_content_alignment == 'Right'){
		$multipurpose_ecommerce_custom_css .='.site-footer ul, .site-footer p, .site-footer .tagcloud{';
			$multipurpose_ecommerce_custom_css .='text-align: right;';
		$multipurpose_ecommerce_custom_css .='}';
	}
	...
	$multipurpose_ecommerce_footer_icon_font_size = get_theme_mod('multipurpose_ecommerce_footer_icon_font_size');
	$multipurpose_ecommerce_custom_css .='.site-info .socialicons a{';
	$multipurpose_ecommerce_custom_css .='font-size: '.esc_attr($multipurpose_ecommerce_footer_icon_font_size).'px;';
	$multipurpose_ecommerce_custom_css .='}';

	//footer icon color
	$multipurpose_ecommerce_footer_icon_color = get_theme_mod('multipurpose_ecommerce_footer_icon_color', '');
	$multipurpose_ecommerce_custom_css .='.site-info .socialicons a{';
		$multipurpose_ecommerce_custom_css .='color: '.esc_attr($multipurpose_ecommerce_footer_icon_color).'!important;';
	$multipurpose_ecommerce_custom_css .='}';

	/*---------------------------Footer top bottom padding -------------------*/
	$multipurpose_ecommerce_footer_padding = get_theme_mod('multipurpose_ecommerce_footer_padding');
	if($multipurpose_ecommerce_footer_padding != false){
		$multipurpose_ecommerce_custom_css .='.site-footer{';
			$multipurpose_ecommerce_custom_css .='padding: '.esc_attr($multipurpose_ecommerce_footer_padding).' 0 !important;';
		$multipurpose_ecommerce_custom_css .='}';
	}
	...
	$multipurpose_ecommerce_menu_font_weight = get_theme_mod('multipurpose_ecommerce_menu_font_weight');
	$multipurpose_ecommerce_custom_css .='.main-navigation a, .navigation-top a,.main-navigation ul li a{';
		$multipurpose_ecommerce_custom_css .='font-weight: '.esc_attr($multipurpose_ecommerce_menu_font_weight).';';
	$multipurpose_ecommerce_custom_css .='}';
	...
	// menu hover effect
	$multipurpose_ecommerce_menus_item = get_theme_mod( 'multipurpose_ecommerce_menus_item_style','None');
	if($multipurpose_ecommerce_menus_item == 'None'){
		$multipurpose_ecommerce_custom_css .='.main-navigation ul li a{';
			$multipurpose_ecommerce_custom_css .='';
		$multipurpose_ecommerce_custom_css .='}';
	}else if($multipurpose_ecommerce_menus_item == 'Zoom In'){
		$multipurpose_ecommerce_custom_css .='.main-navigation ul li a:hover{';
			$multipurpose_ecommerce_custom_css .='transition: all 0.3s ease-in-out !important; transform: scale(1.2) !important;';
		$multipurpose_ecommerce_custom_css .='}';
	}	
	...
	// Post Pagination
	$multipurpose_ecommerce_post_pagination_alignment = get_theme_mod( 'multipurpose_ecommerce_post_pagination_option','Left');
    if($multipurpose_ecommerce_post_pagination_alignment == 'Left'){
		$multipurpose_ecommerce_custom_css .='.navigation nav.pagination{';
		$multipurpose_ecommerce_custom_css .='justify-content: left;';
		$multipurpose_ecommerce_custom_css .='}';
	}else if($multipurpose_ecommerce_post_pagination_alignment == 'Center'){
		$multipurpose_ecommerce_custom_css .='.navigation nav.pagination{';
			$multipurpose_ecommerce_custom_css .='justify-content: center;';
		$multipurpose_ecommerce_custom_css .='}';
	}else if($multipurpose_ecommerce_post_pagination_alignment == 'Right'){
		$multipurpose_ecommerce_custom_css .='.navigation nav.pagination{';
			$multipurpose_ecommerce_custom_css .='justify-content: right;';
		$multipurpose_ecommerce_custom_css .='}';
	}
	...
	if($multipurpose_ecommerce_post_image_dimention == 'Custom Image Size'){
		$multipurpose_ecommerce_custom_css .='.blogger .post-image img{';
	...
	$multipurpose_ecommerce_custom_css .='.blogger.singlebox img{';
	...
	$multipurpose_ecommerce_single_post_image_dimention = get_theme_mod('multipurpose_ecommerce_single_post_image_dimention', 'Default');
	$multipurpose_ecommerce_single_post_featured_image_width = get_theme_mod('multipurpose_ecommerce_single_post_featured_image_width');
	$multipurpose_ecommerce_single_post_featured_image_height = get_theme_mod('multipurpose_ecommerce_single_post_featured_image_height');
	if($multipurpose_ecommerce_single_post_image_dimention == 'Custom Image Size'){
		$multipurpose_ecommerce_custom_css .='.blogger.singlebox .single-post-image img{';
			$multipurpose_ecommerce_custom_css .='width: '.esc_attr($multipurpose_ecommerce_single_post_featured_image_width).'px; height: '.esc_attr($multipurpose_ecommerce_single_post_featured_image_height).'px;';
		$multipurpose_ecommerce_custom_css .='}';
	}

	// Related post image box shadow
	$multipurpose_ecommerce_related_post_image_shadow = get_theme_mod('multipurpose_ecommerce_related_post_image_shadow',0);
	if($multipurpose_ecommerce_related_post_image_shadow != false){
		$multipurpose_ecommerce_custom_css .='.page-box .post-image img{';
			$multipurpose_ecommerce_custom_css .='box-shadow: '.esc_attr($multipurpose_ecommerce_related_post_image_shadow).'px '.esc_attr($multipurpose_ecommerce_related_post_image_shadow).'px '.esc_attr($multipurpose_ecommerce_related_post_image_shadow).'px #cccccc;';
		$multipurpose_ecommerce_custom_css .='}';
	}
